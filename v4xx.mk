...
PRODUCT_COPY_FILES += \
    device/lge/v4xx-common/wcnss/WCNSS_cfg.dat:$(TARGET_OUT_VENDOR)/etc/firmware/wlan/prima/WCNSS_cfg.dat \
    device/lge/v4xx-common/wcnss/WCNSS_qcom_cfg.ini:$(TARGET_OUT_VENDOR)/etc/wifi/WCNSS_qcom_cfg.ini \
    device/lge/v4xx-common/wcnss/WCNSS_qcom_wlan_nv.bin:$(TARGET_OUT_VENDOR)/etc/firmware/wlan/prima/WCNSS_qcom_wlan_nv.bin \
